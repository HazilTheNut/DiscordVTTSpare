...
public class EditorFindAndReplace extends JFrame {
    ...
    public EditorFindAndReplace(EditorTextPanel editorTextPanel, GameMap gamemap, UndoManager undoManager){
        ...
        replaceButton.addActionListener(e -> {
            gamemap.getBackdrop().findAndReplace(findText, replaceText, ((SpinnerNumberModel)replaceChanceSpinner.getModel()).getNumber().intValue());
